...
class Form(FlaskForm):
    ...
    coffee = SelectField(label="Coffee Rating", choices=[(1,"☕"),(2,"☕☕"),(3,"☕☕☕"), (4,"☕☕☕☕"),(5,"☕☕☕☕☕")], validators=[])
    wifi = SelectField(label="Wifi Strength Rating ", choices=[(0, "✘"), (1,"💪"), (2, "💪💪"), (3, "💪💪💪"), (4, "💪💪💪💪"), (5, "💪💪💪💪💪")])
    power = SelectField(label="Power Socket Availability", choices=[(0, "✘"), (1, "🔌"), (2, "🔌🔌"), (3, "🔌🔌🔌"), (4, "🔌🔌🔌🔌"), (5, "🔌🔌🔌🔌🔌")])
